...
function categories_Com01012024_WGS84_1(feature, value, size, resolution, labelText,
                ...
                switch(valueStr) {case 'Cassino':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.988}),fill: new ol.style.Fill({color: 'rgba(225,32,95,0.050980392156862744)'}),
